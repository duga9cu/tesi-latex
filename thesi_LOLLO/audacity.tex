...
Nonostante gli indiscutibili pregi di portabilità, facilità di utilizzo e di reperibilità di documentazione e supporto, non è stato ritenuto vantaggioso sviluppare il software con questa \textsf{SDK}.\\
	...
	L'utilizzo di questo formato è a fondamentale in quanto può essere necessario dover registrare eventi  di lunghezza anche superiore a un'ora, utilizzando decine di canali. 
