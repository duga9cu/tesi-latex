...
\end{figure}
	...
	Principalmente si era discusso sulla possibilità di sviluppare un plug-in utilizzando la SDK della Steinberg\textsuperscript{\textregistered}, per via della diffusione universale e implementazione su quasi tutti i tipi di host e su ogni piattaforma esistente. 
