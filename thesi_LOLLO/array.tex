	...
	Basti pensare alla diffusione della stereofonia negli anni '60 fino all'ormai standard de facto della riproduzione audio domestica o cinematografica, il \emph{Surround~5.1}.
	Esistono anche molte altre tecniche avanzate di riproduzione sonora in grado di avvicinarsi a una simulazione realistica del campo acustico, almeno nel punto di ascolto, quali lo \emph{stereo dipolo binaurale} o la \emph{Wave Field Synthesis WFS} ma non è questa la sede per approfondimenti al riguardo.
	
	Ciò che si vuole sottolineare invece è la necessaria ricerca in campo di registrazione che ha portato a inventare tecniche sempre più innovative per l'acquisizione del campo acustico nei più fini dettagli, quali definizione spaziale, direttività e composizione del segnale.
	...
	Questo approccio costituisce la base della codifica \emph{Ambisonics} inventata dallo stesso Peter Craven e alla base di molti impianti audio odierni.
	Secondo questa teoria, i quattro segnali registrati dalle capsule del sensore tetraedrico, vengono denominati \emph{A-format} e da essi, con un processo matematico teorizzato nella da \emph{Ambisonics}, è possibile ottenere quattro segnali che caratterizzano in prima approssimazione il campo vettoriale acustico nel punto in cui è posta la sonda:
	\begin{itemize}
	...
	\begin{description}
	  ...
	  \item[Cilindrico:] array progettato dal gruppo di Acustica dell'Università degli Studi di Parma\footnote{si veda~\cite{ebri}}  sul modello dell'array sferico \eigen \emph{EM32} ma con alcune aggiunte di progetto.
	  \item[Planare:] progettato dal gruppo di acustica nel 2009\footnote{si veda~\cite{zanettini}.} e migliorato negli anni con alcune modifiche sostanziali. 
	\end{description}
...
\end{figure}
	...
	Il modello planare costruito all'università di parma, dal gruppo di Acustica del Dipartimento di Ingegneria Industriale dell’Università degli studi di Parma, guidato dal Prof. Ing. Angelo Farina, presenta una disposizione delle capsule secondo una spirale logaritmica modificata: questa figura geometrica dovrebbe portare a una risoluzione acustica migliore rispetto alla disposizione delle capsule randomizzata. 
